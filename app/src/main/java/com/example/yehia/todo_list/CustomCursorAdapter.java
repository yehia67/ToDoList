...
public class CustomCursorAdapter extends RecyclerView.Adapter<CustomCursorAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        int idIndex = mCursor.getColumnIndex(Contract.tasks._ID);
        int descriptionIndex = mCursor.getColumnIndex(Contract.tasks.colume_desc);
        int priorityIndex = mCursor.getColumnIndex(Contract.tasks.colume_prior);
